...
from ..pokemon.views import MANUAL_RULESET, AUTO_RULESET, ROUTE_RULESET, SPECIAL_RULESET
from ..utils import pokemon_verification
...
@main.route('/send_media/<path:filename>')
def send_media(filename):
    from pifsm import app
